...
class ServerTemplate2 implements GameEventsHandler {
    // update game logic (e.g. position, collision detection) at rate 60fps approx.
    private readonly gameUpdateInterval = 1000 / 120
    private readonly connectedSockets: DomainSocket[] = []
...
class SingletonServer2 {
    private static instance: ServerTemplate2;

    private constructor() {
    }

    static getInstance(): ServerTemplate2 {
        if (!this.instance) {
            this.instance = new ServerTemplate2();
        }
